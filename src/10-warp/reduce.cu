#include "error.cuh"
#include <stdio.h>
#include <cooperative_groups.h>//necessary for using cooperative group
using namespace cooperative_groups;//necessary for using cooperative group
...
***/
    ...
    // 32 threads in a thread warp, from 128->32 do not using the shfl_down_sync
    // width = 64 for example > 32, gpu using default w=32 instead of 64
    //for (int offset = 16; offset > 0; offset >>= 1)
    {
