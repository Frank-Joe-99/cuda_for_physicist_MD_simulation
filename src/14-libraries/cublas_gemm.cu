...
int main(void)
{
    ...
    cublasSetVector(MK, sizeof(double), h_A, 1, g_A, 1); // copy matrix from host to device
    ...
    cublasGetVector(MN, sizeof(double), g_C, 1, h_C, 1);// copy matrix from device to host 
